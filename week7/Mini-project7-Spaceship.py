...
class Ship:
    ...
    def draw(self,canvas):
        ...
        canvas.draw_image(self.image, [self.image_center[0]+self.image_size[0]*self.thrust, self.image_center[1]],
...
def update_ship_angle_v(unit):
    my_ship.set_angle_vel(unit)
